...
public class CrearFichNombres {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        String nombres[] = {"Real Sociedad","Athletic","Osasuna","Alavés","Celta","Barcelona","Madrid","Valencia","Leganés","Eibar","Getafe","Granada","Valladolid","Levante","Villarreal","Espanyol","Mallorca","Athletico","Betis","Sevilla"};
        int i = 0;
